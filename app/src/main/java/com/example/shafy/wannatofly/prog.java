...
public class prog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVisible = true;
        TextView out =(TextView)findViewById(R.id.quiz);
        ...
        alarm= MediaPlayer.create(this,R.raw.note);
        alarm.start();
        alarm.setLooping(true);

    }

    public void stopA(View view){

        EditText in=(EditText)findViewById(R.id.in);
        if (in.getText().toString().equals("56")||in.getText().toString().equals("36")){
            alarm.stop();
        }
        else {
